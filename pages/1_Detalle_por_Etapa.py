...
st.set_page_config(
    page_title="Detalle por Etapa ┬À Reforma Curricular",
    page_icon="­ƒôï",
    layout="wide",
...
# ÔöÇÔöÇ Datos ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
df_raw = load_data()
...
# ÔöÇÔöÇ Sidebar ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
with st.sidebar:
    st.markdown(
    ...
    st.page_link("app.py",                              label="Resumen General",      icon="­ƒôè")
    st.page_link("pages/1_Detalle_por_Etapa.py",        label="Detalle por Etapa",    icon="­ƒôï")
    st.page_link("pages/2_Programa.py",                 label="Resumen Programa",     icon="­ƒöì")
    st.markdown(
        '<div style="padding:12px 6px;font-size:10px;color:rgba(255,255,255,0.40);text-align:center">'
        'POLI ┬À 2025ÔÇô2026</div>',
        unsafe_allow_html=True,
    )

# ÔöÇÔöÇ Header banner ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
st.markdown(
    '<div style="'
...
# ÔöÇÔöÇ Filtros ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
_pers_ops  = sorted(df_raw["PERIODO DE IMPLEMENTACI├ôN"].dropna().unique().tolist())
...
with st.container():
    # Fila 1: MODALIDAD ┬À FACULTAD ┬À LIMPIAR
    lb1, in1, _sp, lb2, in2, btn_col = st.columns([0.6, 2.5, 0.05, 0.6, 2.7, 0.8])
    with lb1:
        st.markdown(f'<div {_LBL}>­ƒôï MODALIDAD</div>', unsafe_allow_html=True)
    with in1:
        if _use_pills:
    ...
    with lb2:
        st.markdown(f'<div {_LBL}>­ƒÅø´©Å FACULTAD</div>', unsafe_allow_html=True)
    with in2:
        if _use_pills:
            ...
            sel_fac = st.multiselect("fac", fac_ops, key="p1_fac",
                                     label_visibility="collapsed", placeholder="Todas")
    with btn_col:
        st.button("Ô£ò LIMPIAR", on_click=_clear_p1,
                  type="primary", key="p1_clear")

    # Fila 2: PER├ìODO ┬À NIVEL ┬À PROCESO ┬À contador
    lb3, in3, lb_nivel, in_nivel, _sp2, lb4, in4, cnt_col = st.columns([0.6, 2.3, 0.65, 2.0, 0.05, 0.85, 2.3, 1.1])
    with lb3:
        st.markdown(f'<div {_LBL}>­ƒôà PER├ìODO</div>', unsafe_allow_html=True)
    with in3:
        if _use_pills:
    ...
    with lb_nivel:
        st.markdown(f'<div {_LBL}>­ƒÄô NIVEL</div>', unsafe_allow_html=True)
    with in_nivel:
        if _use_pills:
    ...
    with lb4:
        st.markdown(f'<div {_LBL}>ÔÜÖ´©Å PROCESO</div>', unsafe_allow_html=True)
    with in4:
...
# SECCI├ôN 1 ÔÇö Consolidado por etapa: barra mini + conteos
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
st.markdown(
...
st.markdown(
    ...
    '<div style="flex:1;font-size:12px;font-weight:700;color:#4a6a7e">Distribuci├│n</div>'
    '<div style="width:48px;font-size:12px;font-weight:700;color:#A6CE38;text-align:center">Ô£ô Final</div>'
    '<div style="width:48px;font-size:12px;font-weight:700;color:#1FB2DE;text-align:center">ÔùÄ Proc.</div>'
    '<div style="width:48px;font-size:12px;font-weight:700;color:#EC0677;text-align:center">Ô£ù Sin ini.</div>'
...
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
# SECCI├ôN 2 ÔÇö Gr├ífico de barras apiladas por proceso (conteo total)
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
st.markdown("### Vista Gr├ífica por Proceso")
...
with col_g1:
    st.markdown("##### Distribuci├│n de estados por proceso (etapas ├ù programas)")
    fig_sp = go.Figure()
    all_data = [
...
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
# SECCI├ôN 3 ÔÇö Tabla detalle programa ├ù etapa
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
...
base_cols = {
    ...
    "FACULTAD":                  "Facultad",
    "MODALIDAD":                 "Modal.",
    "PERIODO DE IMPLEMENTACI├ôN": "Periodo",
    "avance_general":            "Avance %",
}
df_base = df[list(base_cols.keys())].copy().reset_index(drop=True)
df_det  = df_base.rename(columns=base_cols)
df_det["Facultad"] = df["FACULTAD"].map(fac_abrev).fillna("ÔÇö").reset_index(drop=True)
df_det["Avance %"] = df_det["Avance %"].apply(lambda x: f"{int(x)}%" if pd.notna(x) else "ÔÇö")
...
def _fmt_date(val):
    ...
    try:
        ...
        return str(val) if str(val).strip() not in ("", "None", "nan", "ÔÇö") else "ÔÇö"

etapa_labels = []
for i, em in etapas_show:
    _, _, _, tipo = em
    col_label = f"{em[1][:28]}ÔÇª" if len(em[1]) > 28 else em[1]
    etapa_labels.append((i, col_label, tipo))
    raw = df_cl[f"val_{i}"]
    if tipo == "pct":
        df_det[col_label] = raw.apply(
            lambda v: _fmt_pct(v) if v not in ("ÔÇö", "No aplica", "no aplica") else v)
    elif tipo == "date":
        df_det[col_label] = raw.apply(_fmt_date)
    else:
        cl_col = df_cl[f"cl_{i}"]
        df_det[col_label] = [
            STATUS_LABEL.get(cl, (str(v)[:1].upper() + str(v)[1:]) if v and str(v) not in ("ÔÇö","nan","None","") else "ÔÇö")
            for cl, v in zip(cl_col, raw)
        ]

# ÔöÇÔöÇ Colores sem├íforo (aplicados columna por columna para evitar KeyError) ÔöÇÔöÇÔöÇÔöÇ
_CL_STYLE = {
...
st.caption(f"{n} programas ┬À {len(etapas_show)} etapas mostradas")
